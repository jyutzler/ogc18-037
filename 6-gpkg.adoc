...
Add a row to this table for each OWS Context offering as shown in <<gpkgext_context_contents_table>>. (This table implements owc:SQLContent as per <<owc_sql_content>>.)
